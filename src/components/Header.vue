...
=
  ...
  Filter
    ...
    <transition name="fade">
      <nav
        v-if="isMenuOpen"
        class="md:hidden fixed top-16 left-0 right-0 bg-gray-900 border-t border-gray-700 p-4 flex flex-col space-y-4 z-50"
      >
        <router-link to="/" class="block text-white hover:text-indigo-400 transition" @click="toggleMenu">Home</router-link>
        <router-link to="/about" class="block text-white hover:text-indigo-400 transition" @click="toggleMenu">About</router-link>
        <router-link to="/services" class="block text-white hover:text-indigo-400 transition" @click="toggleMenu">Services</router-link>
        <router-link to="/contact" class="block text-white hover:text-indigo-400 transition" @click="toggleMenu">Contact</router-link>
      </nav>
    </transition>
  </header>
</template>
